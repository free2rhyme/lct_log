...
class CRotateFileSink final: public CLctLogSink<CRotateFileSink, CLctLogMessageShp>
{
public:
...
protected:
   LCT_ERR_CODE sinkIt(const CLctLogMessageShp& message)
   {
...
typedef std::shared_ptr<CRotateFileSink>   CRotateFileSinkShp;
...
class CDailyFileSink final: public CLctLogSink<CDailyFileSink<FileNameCalc> , CLctLogMessageShp>
{
public:
...
typedef std::shared_ptr<CDailyFileSink<CDailyDateFileNameCalculator> >   CDailyFileSinkShp;
 ...
 *
 * *****************************************************************************/
class CDailyRotateFileSink final: public CLctLogSink<CDailyRotateFileSink , CLctLogMessageShp>
{
public:
...
typedef std::shared_ptr<CDailyRotateFileSink>   CDailyRotateFileSinkShp;
 ...
 *
 * *****************************************************************************/
class CDailyRotateTerminalSink final: public CLctLogSink<CDailyRotateTerminalSink , CLctLogMessageShp>
{
public:
   CDailyRotateTerminalSink()
   {
...
typedef std::shared_ptr<CDailyRotateTerminalSink>   CDailyRotateTerminalSinkShp;
...
class CRemoteSink final : public CLctLogSink<CRemoteSink, CLctLogMessageShp>
{
public:
...
typedef std::shared_ptr<CRemoteSink>   CRemoteSinkShp;
